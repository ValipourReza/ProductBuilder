...
public class ProductService {
    ...
    /**
     * Dashboard-specific read model: products are returned with their features initialized.
     */
    @Transactional(readOnly = true)
    public List<Product> findAllWithFeatures() {
        return repository.findAllWithFeatures();
    }
